        ...
        this.show = function (op) {
                ...
                function addBtnEvent(e) {
                    ...
                    if (this.name == 'favorite') {
                        ...
                        if (weixin) {
                            ...
                            temp = '<div class="w_center">' + '<div id="w_qr" class="w_qr" width="90" height="90"></div>' + '<p class="w_cont">使用微信“扫一扫”分享到朋友圈。</p>' + '</div>' + '<div id="triangle" class="w_bottom"></div>' + '<div id="w_close" class="w_close"></div>';
            ...
            function toggle() {
                ...
                if (share_btn.length && share_box.length) {
                    ...
                    var show_share_box = function show_share_box() {
                        if (tid) {
                            clearTimeout(tid);
                        }
                    ...
                    var hide_share_box = function hide_share_box(timeout) {
                        if (timeout) {
